...
FEATURES = (
    "open", "high", "low", "close", "volume", "amount", "turnover", "vwap", "ret",
    "event_heat", "theme_sentiment", "video_bullish_claim_count", "video_bearish_claim_count",
    "verified_catalyst_count", "verified_risk_count", "author_attention_score",
    "cross_video_consensus", "cross_video_disagreement",
)
...
ALL_OP_TOKENS = frozenset(
    ...
    + list(CS_OPS) + list(UNARY_OPS) + list(BINARY_OPS) + list(TERNARY_OPS)
)
