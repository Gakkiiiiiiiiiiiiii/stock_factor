...
def _metrics(ma: float, boll: float, primitive: float, phase: float, event: float) -> dict:
    return {
        "summary": {
            "ma_slope_mean_pearson": ma,
            "ma_slope_mean_sign_accuracy": ma,
            "ma_alignment_spearman": ma,
            "ma_compression_pearson": ma,
            "bollinger_percent_b_pearson": boll,
            "bollinger_boll_zscore_pearson": boll,
            "bollinger_bandwidth_pearson": boll,
            "bollinger_squeeze_spearman": boll,
            "bollinger_expansion_spearman": boll,
            "wyckoff_primitive_mean_spearman": primitive,
            "phase_macro_f1": phase,
            "phase_js_divergence": 0.0,
            "phase_ece": 0.0,
            "event_mean_relative_pr": event,
            "event_mean_f1": event,
            "event_precision_at_top1pct": event,
            "event_precision_at_top5pct": event,
        }
    }
