...
def _split() -> dict:
    return {
        ...
        "summary": {
            "ma_slope_mean_pearson": 1.0,
            "ma_slope_mean_sign_accuracy": 1.0,
            "ma_alignment_spearman": 1.0,
            "ma_compression_pearson": 1.0,
            "bollinger_percent_b_pearson": 1.0,
            "bollinger_boll_zscore_pearson": 1.0,
            "bollinger_bandwidth_pearson": 1.0,
            "bollinger_squeeze_spearman": 1.0,
            "bollinger_expansion_spearman": 1.0,
            "wyckoff_primitive_mean_spearman": 1.0,
            "phase_macro_f1": 1.0,
            "phase_js_divergence": 0.0,
            "phase_ece": 0.0,
            "event_mean_relative_pr": 1.0,
            "event_mean_f1": 1.0,
            "event_precision_at_top1pct": 1.0,
            "event_precision_at_top5pct": 1.0,
        },
    }
...
def test_complete_production_fixture_passes_and_promotes() -> None:
    ...
    report = build_reliability_report(
        ...
        gold_set={
            ...
            "allowed_split_passed": True,
            "coverage_passed": True,
            "phase": {"macro_f1": 1.0},
            "event": {"pr_auc_multiple_of_prevalence": 2.0},
        },
        embedding={
            "status": "EVALUATED",
            "passed": True,
            "weak_phase_neighbor_hit": 1.0,
            "gold_neighbor_semantic_hit": 1.0,
        },
        invariance={
            "status": "EVALUATED",
            "passed": True,
            "raw_source_available": True,
            "feature_noise_invariance": {"cosine": 1.0},
            "raw_noise_invariance": {
                "embedding_cosine": 1.0,
                "phase_js_divergence": 0.0,
                "event_median_probability_delta": 0.0,
            },
            "price_scale_cosine": 1.0,
        },
    ...
    try:
        (checkpoint_dir / "checkpoint_manifest.json").write_text(
            json.dumps({**checkpoint, "checkpoint_status": "CANDIDATE"}), encoding="utf-8"
        )
